        ...
        <div className="FullPage">
          ...
          >
            ...
            <div className="AdminBrandName">
              <span>Velvet Home's Admin's Page</span>
            </div>
          </div>
          <div
                  ...
                  <div className="CHPcardMain">
                    ...
                    <div className="CHPcardMainDiv">
                      ...
                      <div
                        ...
                        style={{ borderTop: "1px solid #22A699" }}
                      >
                        +Rs. {p} this month
                      </div>
                    </div>
            ...
            <div className="MostAndLeastSellingCon">
              <div className="MostSellingCon">
                <div
                  ...
                  id="CompTrackSalesID"
                  style={{ fontSize: "xx-large", height: "60px" }}
                >
                  Most Selling Comp.
                </div>
                <div className="SalesChartsCon">
                ...
                <div className="SalesChartsCon">
                  ...
                  >
                    <div className="AdminInputCon">
                      <label htmlFor="code" className="AdminInputLabel">
                        Enter Code:{" "}
                      </label>
                      <input
                        type="text"
                    ...
                    {formData.to === "SPECIFIC" && (
                      <div className="AdminInputCon">
                        <label htmlFor="username" className="AdminInputLabel">
